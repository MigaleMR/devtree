  ...
  return (
    <form onSubmit={handleSubmit(handleSearch)} className="space-y-5">
      ...
      <div className="mt-10"> 
        ...
        {mutation.data && <p className="text-center text-cyan-500 font-black">{mutation.data}. Ir a <Link className="text-cyan-700" to={'/auth/register'}state={{handle : slugify(handle) }}>Registro</Link></p>}
      </div>
